...
?>
		...
		foreach ($attrnames as $attr_slug => $attr_td_value) {
			...
			$allcolumns['vartable_variations'] .= apply_filters( 'vartable_attributes_join', '<td class="optionscol ' . $attr_slug . '" data-sort-value="'. $data_sort_value .'" data-label="' . apply_filters('vartable_dl_options', $attr_ordernames[str_replace(array(
				'_',
				'.',
				' '
			) , array(
				...
				' . apply_filters( 'vartable_attributes_term_output', htmlentities( $attr_td_value, ENT_QUOTES ), $value, $attr_slug, $attr_td_value, $attrnames, $product ) . '</td>', 
				$value, 
				$attr_slug, 
				$attr_td_value, 
				$attrnames,
